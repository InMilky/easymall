...
<html>
			...
			$(function(){
				...
				$("input[name='username']").blur(function(){
					if(!formobj.checkNull("username", "用户名不能为空！")){
						...
						var url="${ pageContext.request.contextPath }/admin/checkAdmin";
	...
	-->
		<form onsubmit="return formobj.checkForm();" action="${ pageContext.request.contextPath }/admin/adminRegist" method="POST">
			<h1>欢迎注册EasyMall</h1>
			<table>
				<tr>
				...
				<tr>
					<td class="sub_td" colspan="2" class="tds">
						<input class="btn" type="button" onclick="javascript:window.location.href='${ pageContext.request.contextPath }/index/adminlogin'" value="后台登录"/>
					</td>
				</tr>
			</table>
		</form>
